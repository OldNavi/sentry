...
class DailySummaryTest(
    ...
    def setUp(self):
        responses.add(
            ...
            url=f"{settings.SENTRY_SNUBA}/tests/outcomes/drop",
            status=200,
        )
        super().setUp()
    ...
    def test_slack_message_contents(self):
        self.populate_event_data()
        # CEO: not sure how to activate responses and also store events
        # it's mad I haven't mocked  POST http://127.0.0.1:1218/tests/entities/groupedmessage/insert
        # in self.create_group. I hope I'm doing this wrong and there is an easier way
        responses.add(
            method=responses.POST,
